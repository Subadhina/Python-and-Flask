...
con_string = "mongodb+srv://suba:suba@cluster0.k35hqto.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('example')

user_collection = pymongo.collection.Collection(db, 'excollection') #(<database_name>,"<collection_name>")
